...
public class FoodProviderController extends HttpServlet {
	...
	private void updateFood(String id, HttpServletRequest request, HttpServletResponse response)
		...
		;
		RequestDispatcher rd = request.getRequestDispatcher("food_provider_update.jsp");
	...
	private void addFood(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		RequestDispatcher rd = request.getRequestDispatcher("food_provider_add.jsp");
		rd.forward(request, response);
