		...
		<h3 style="text-align:center">Danh sách nhà cung cấp thực phẩm</h3>
			<table class="data-table">
				...
				<tr>
					...
					<td><a
						href="provider?action=delete&id=<%=model.getIdProvider()%>">Xóa</a>
						<a href="provider?action=update&id=<%=model.getIdProvider()%>">Sửa</a>
					</td>
				</tr>
				<%
							}
			...
			<div style="margin-top: 10px">
				<a href="provider?action=add">Thêm nhà cung cấp thực phẩm mới</a>
