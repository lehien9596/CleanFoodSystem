		...
		<h3 style="text-align:center">Danh sách nhà cung cấp thực phẩm</h3>
			<table class="data-table">
				...
				<tr>
					...
					<td><a
						href="provider2?action=delete&id=<%=model.getIdProvider()%>">Xóa</a>
						<a href="provider2?action=update&id=<%=model.getIdProvider()%>">Sửa</a>
					</td>
				</tr>
				<%
							}
			...
			<div style="margin-top: 10px">
				<a href="provider2?action=add">Thêm nhà cung cấp thực phẩm mới</a>
